...
\section{Lit Review}
\subsection{CSP}
Manyam et al \cite{10863160} applied algorithms to solve Sudoku puzzles. As nonograms have well defined rules like sudoku, similar studies can be conducted.
